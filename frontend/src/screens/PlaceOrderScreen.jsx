...
const PlaceOrderScreen = () => {
  ...
  // Use our new hook to create an order
    ...
    try {
      ...
      const res = await createOrder({
        orderItems: cart.cartItems.map((item) => ({
          ...item,
          product: item._id, // <--- The Translation
          _id: undefined,    // Optional: Clean up the old ID to avoid confusion
        })),
        ...
        <Col md={4}>
          <Card>
            <ListGroup variant='flush'>
              ...
              {error && (
                <ListGroup.Item>
                  <div className="text-danger">{error?.data?.message || error.error}</div>
                </ListGroup.Item>
              )}
